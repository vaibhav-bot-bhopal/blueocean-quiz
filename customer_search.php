...
if(($_POST['email']) && ($_POST['quiz']) && ($_POST['quiz']) != '')
{
   ...
   $newgmail91 = "+91".substr($email, -10, 10); 
    ...
    if($rowcount)
    {
        ...
        $mydata .= "</div>";
        if($quiz=='barasingha_july_quiz_2021'){
          $mydata .= "<a href='assets\certificate\\$quiz\\$c_email.jpg' target='_blank' class='btn btn-primary' style='width:200px;margin:0px auto; font-size: 14px; font-weight: 600;'>Download Certificate</a>"; 
